...
def parse_args(args=None):
    ...
    parser.add_argument('--outdir', help='Where to save the output images (default: %(default)s)', metavar='DIR', default='out')
...
def main():
    #args = parse_args(['--seeds=85,265,297,849', '--network=./pretrained/afhqdog.pkl'])
    args = parse_args()
